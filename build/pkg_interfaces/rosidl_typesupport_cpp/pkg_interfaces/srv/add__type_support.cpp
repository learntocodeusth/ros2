...
static const _Add_Event_type_support_symbol_names_t _Add_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, pkg_interfaces, srv, Add_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, pkg_interfaces, srv, Add_Event)),
  }
};
...
{
  return &::pkg_interfaces::srv::rosidl_typesupport_cpp::Add_Event_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, pkg_interfaces, srv, Add_Event)() {
  return get_message_type_support_handle<pkg_interfaces::srv::Add_Event>();
}
...
static const rosidl_service_type_support_t Add_service_type_support_handle = {
  ...
  ::rosidl_typesupport_cpp::get_message_type_support_handle<pkg_interfaces::srv::Add_Request>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<pkg_interfaces::srv::Add_Response>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<pkg_interfaces::srv::Add_Event>(),
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_cpp, pkg_interfaces, srv, Add)() {
  return ::rosidl_typesupport_cpp::get_service_type_support_handle<pkg_interfaces::srv::Add>();
}
