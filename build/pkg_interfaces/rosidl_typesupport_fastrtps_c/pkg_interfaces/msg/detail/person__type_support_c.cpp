  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = pkg_interfaces__msg__Person;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const pkg_interfaces__msg__Person * ros_message = static_cast<const pkg_interfaces__msg__Person *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_pkg_interfaces__msg__Person(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  pkg_interfaces__msg__Person * ros_message = static_cast<pkg_interfaces__msg__Person *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_pkg_interfaces__msg__Person(cdr, ros_message);
}
