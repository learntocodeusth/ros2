...
class Add_Event(metaclass=Metaclass_Add_Event):
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<pkg_interfaces/Add_Request, 1>',
        'response': 'sequence<pkg_interfaces/Add_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['pkg_interfaces', 'srv'], 'Add_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['pkg_interfaces', 'srv'], 'Add_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from pkg_interfaces.srv import Add_Request
    ...
    def response(self, value):
        if self._check_fields:
            from pkg_interfaces.srv import Add_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
...
class Metaclass_Add(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from pkg_interfaces.srv import _add
...
class Add(metaclass=Metaclass_Add):
    from pkg_interfaces.srv._add import Add_Request as Request
    from pkg_interfaces.srv._add import Add_Response as Response
    from pkg_interfaces.srv._add import Add_Event as Event
